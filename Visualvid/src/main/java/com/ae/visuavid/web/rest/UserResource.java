...
import com.ae.visuavid.service.UserService;
import com.ae.visuavid.service.dto.UserDTO;
import com.ae.visuavid.web.rest.errors.BadRequestAlertException;
import com.ae.visuavid.web.rest.errors.EmailAlreadyUsedException;
import com.ae.visuavid.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> getUserDetails(@PathVariable String token) {
        log.debug("REST request to get User : {}", token);
        return ResponseUtil.wrapOrNotFound(userService.getUserWithToken(token).map(UserDTO::new));
    }
