...
public class OrderRepositoryImpl implements OrderRepositoryCustom {
    ...
    @Override
    public void updateRazorPayOrderId(UUID id, String paymentOrderId, String orderStatus, UUID userId) {
        String updateQuery = "update vvid_order set razor_pay_order_id = ?,order_status = ?,user_id = ?  where id = ?";
        jdbcTemplate.update(updateQuery, paymentOrderId, orderStatus, userId, id);
    }
