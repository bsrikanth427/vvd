...
public class UserSubscriptionService {
    ...
    private UserSubscriptionEntity prepareUserSubscription(UserSubscriptionDTO dto) {
        ...
        if (subscriptionEntity != null) {
            ...
            if (userOptional.isPresent()) {
                ...
                userOptional = userRepository.findById(dto.getUserId());
                if (userOptional.isPresent()) {
                    entity.setUser(userOptional.get());
                    entity.setUserName(userOptional.get().getLogin());
                }
    ...
    public UserSubscriptionDTO createUserSubscription(UserSubscriptionDTO dto) {
        ...
        SubscriptionDTO subEntity = subscriptionService.findById(dto.getSubscriptionId());
        entity.setBasicAmount(subEntity.getMonthlyPriceLocal());
        dto.setAmountPaid(subEntity.getMonthlyPriceLocal());
        ...
        entity.setRazorPayKey(paymentOrderDTO.getRazorPayKey());
